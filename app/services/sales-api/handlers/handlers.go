...
import (
	...
	v1TestGrp "github.com/gksbrandon/service/app/services/sales-api/handlers/v1/testgrp"
	v1UserGrp "github.com/gksbrandon/service/app/services/sales-api/handlers/v1/usergrp"
	userCore "github.com/gksbrandon/service/business/core/user"
...
func v1(app *web.App, cfg APIMuxConfig) {
	...
	app.Handle(http.MethodGet, version, "/users/:id", ugh.QueryByID, mid.Authorize(auth.RoleAdmin))
