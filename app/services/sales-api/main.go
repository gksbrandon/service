...
func main() {
	// Construct the appliation logger
...
func run(log *zap.SugaredLogger) error {
	...
	// Tags represent the default values that will be applied
	cfg := struct {
		conf.Version
		Web struct {
	...
	// Values from environment or cli provided will override default values
	const prefix = "SALES"
